        ...
        <div class="content-show">
            ...
            <div class="row list-search">
                ...
                <div class="col-md-4 search-field">
                    ...
                    <el-date-picker class="el-field-input" size="large" v-model="value1" type="date" placeholder="选择制单日期">
                    </el-date-picker>
                </div>
                <div class="col-md-4 search-field">
                    <div class="label">保修截止日期：</div>
                    <el-date-picker class="el-field-input" size="large" v-model="value2" type="date" placeholder="选择保修截止日期">
                    </el-date-picker>
                </div>
            </div>
            <div class="row list-search">
