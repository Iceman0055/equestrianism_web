<template>
    <div class="content_page animated zoomIn">
        <div class="content-title">
            ...
            <div class="title" v-if="!useDisabled &&assetId">修改消耗品</div>
            <div class="title" v-if="!assetId">新增消耗品</div>
        ...
        <div class="content-footer row" v-show="!useDisabled">
            <el-button v-if="!assetId" class="col-md-1 btn btn-primary makesure" :plain="true" @click="addConsume('assetsInfo')">确定</el-button>
            <el-button v-if="assetId" class="col-md-1 btn btn-primary makesure" :plain="true" @click="updateConsume('assetsInfo')">修改</el-button>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        addConsume(formName) {
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    hosAssetsSrv.addConsume(this.assetsInfo).then(
                        resp => {
        ...
        //     };
        //     hosAssetsSrv.addConsume(assetsInfo).then(
        //         resp => {
        //             this.$message.success("添加消耗品信息成功");
        //             this.$router.push("/hosAssets/consume");
        //         },
