        ...
        <div class="content-show">
            ...
            <div class="row list-search">
                <div class="col-md-4 search-field">
                    ...
                    <el-date-picker class="el-field-input" size="large" v-model="financialDate" format="yyyy-MM-dd" value-format="yyyy-MM-dd" type="date" placeholder="选择财务入账日期">
                    </el-date-picker>
                </div>
                <div class="col-md-4 search-field">
