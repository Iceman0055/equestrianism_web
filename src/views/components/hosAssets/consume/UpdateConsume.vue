        ...
        <div class="content-show">
            <div class="row list-search">
                <div class="col-md-4 search-field">
                    ...
                    <el-select size="large" :disabled="useDisabled" v-model="assetsCate" class="el-field-input" placeholder="请选择">
                ...
                <div class="col-md-4 search-field">
                    ...
                    <el-select size="large" :disabled="useDisabled" v-model="assetsClass" class="el-field-input" placeholder="请选择">
            ...
            <div class="row list-search">
                ...
                <div class="col-md-4 search-field">
                    ...
                    <el-select size="large" :disabled="useDisabled" v-model="useStatus" class="el-field-input" placeholder="请选择">
