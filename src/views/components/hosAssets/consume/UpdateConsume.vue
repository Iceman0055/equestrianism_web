<template>
    <div class="content_page animated zoomIn">
        ...
        <div class="content-show">
            ...
            <div class="row list-search">
                ...
                <div class="col-md-4 search-field">
                    ...
                    <el-date-picker :disabled="useDisabled" class="el-field-input" size="large" v-model="makeDate" format="yyyy-MM-dd0" value-format="yyyy-MM-dd" type="date">
                    </el-date-picker>
                </div>
                <div class="col-md-4 search-field">
        ...
        <div class="content-footer row" v-show="!useDisabled">
            <el-button class="col-md-1 btn btn-primary makesure" :plain="true" @click="updateConsume">确定</el-button>
        </div>
    </div>
</template>
...
export default {
  ...
  methods: {
    ...
    updateConsume() {
      ...
      hosAssetsSrv.updateConsume(assetsInfo).then(
        resp => {
