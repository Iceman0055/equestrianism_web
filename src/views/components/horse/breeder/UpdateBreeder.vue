<template>
    <div class="content_page animated zoomIn">
        <div class="content-title">
            <div class="title" v-if="!useDisabled">更新饲养员信息</div>
        ...
        <div class="content-show">
            ...
            <div class="row list-search">
                <div class="col-md-4 search-field">
                    ...
                    <el-upload :disabled="useDisabled" class="avatar-uploader" action="" :auto-upload="false" :show-file-list="false" :on-change="submitFile" :on-success="handleAvatarSuccess" :before-upload="beforeAvatarUpload">
